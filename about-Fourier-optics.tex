...
$\V{j}' \in Ω_{0}$ where $Ω_{0}$ includes the nodes for which the field $u_{0}$
...
which includes the nodes where the field in the output transverse plane is
...
implemented as the deconvolution by the forward propagation kernel.
